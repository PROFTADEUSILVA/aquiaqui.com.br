...
class _GenerateTagScreenState extends State<GenerateTagScreen> {
  ...
  String get _whatsappLink {
    ...
    return 'https://proftadeusilva.github.io/aquiaqui.com.br?id=$id&name=$name&age=$age&phone=$phone&gender=$_genero';
  }
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text('Aparecem quando alguém escaneia a pulseira.',
              style: TextStyle(color: Colors.grey)),
          const SizedBox(height: 24),
          _campo('Nome da criança', _nameCtrl, Icons.child_care,
              type: TextInputType.name),
          const SizedBox(height: 14),
          _campo('Idade', _ageCtrl, Icons.cake_outlined,
          ...
          const SizedBox(height: 14),
          _campo('Seu WhatsApp (DDD + 9 dígitos)', _phoneCtrl,
              Icons.phone_outlined,
              type: TextInputType.phone),
          const SizedBox(height: 6),
          const Text('Ex: 71999990000',
              style: TextStyle(color: Colors.grey, fontSize: 12)),
          const SizedBox(height: 24),
          const Text('Plano da pulseira',
              style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600)),
          const SizedBox(height: 10),
          ...TagPlan.values.map((p) => _PlanCard(
                plan: p,
                selected: _plano == p,
                onTap: () => setState(() => _plano = p),
              )),
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                Text('${tag.childAge} anos  •  ${tag.plan.label}',
                ...
                Container(
                  ...
                  child: Text('Válida por ${tag.plan.label}',
                      style: const TextStyle(
          ...
          Container(
            ...
            child: const Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    'Quando alguém escanear, abre a página Aqui com localização automática.',
          ...
          Container(
            ...
            child: const Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    'Imprima, plastifique e coloque na pulseira da criança.',
                    style: TextStyle(color: Color(0xFF633806), fontSize: 13),
                  ),
                ),
              ],
            ),
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color:
                selected ? const Color(0xFF1D9E75) : Colors.grey.shade200,
            width: selected ? 2 : 1,
          ),
        ),
        child: Row(
          children: [
            Icon(
              plan == TagPlan.hours24
                  ? Icons.wb_sunny_outlined
                  : plan == TagPlan.hours48
